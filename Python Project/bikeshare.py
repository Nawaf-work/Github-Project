...
def gather_information():
    ...
    city_value = input("\nwhich city you wanted to see the data for?, these are the available cities,  NEW YORK , CHICAGO , WASHINGTON/n \n").lower()
    ...
    month_value = input("\nEnter which month you want? January, February, March, April, May, or June?, \n").lower()
